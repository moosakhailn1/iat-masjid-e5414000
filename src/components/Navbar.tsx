  ...
  return (
    <>
      <div className={`iat-header-stack${scrolled ? ' scrolled' : ''}`}>
        ...
        <div className="iat-top-bar">
          <div className="iat-top-inner">
            ...
            <div className="iat-top-right">
              <a href="mailto:abuhanifahiat@gmail.com">
                ...
                <span>abuhanifahiat@gmail.com</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <nav className="iat-nav-inner">
          <a href="/" className="iat-brand">
            <span className="iat-site-name">Islamic Association of Texas</span>
            <span className="iat-site-tag">Community • Education • Worship</span>
          </a>

          <div className="iat-nav-links">
            {NAV_LINKS.map(({ label, href, isDonate }) => (
      ...
      <div className="iat-ribbon-banner">
        <div className="iat-ribbon-text">Ramadan Mubarak — Islamic Association of Texas</div>
      </div>

      {/* Mobile sidebar */}
      <div className={`iat-mobile-sidebar${sidebarOpen ? ' open' : ''}`}>
        <div className="iat-mobile-top">
          <span className="iat-mobile-title">Islamic Association of Texas</span>
